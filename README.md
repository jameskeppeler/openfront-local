<!--
  ► LOCAL SETUP & CUSTOM REAL-WORLD MAPS: see SETUP.md
    Run the game offline (Windows: Play-OpenFront.bat / macOS: Play-OpenFront.command)
    and generate playable maps from any region on Earth. Full guide: ./SETUP.md
-->

> **Running this locally or making custom maps?** See **[SETUP.md](SETUP.md)** for
> one-click launchers (Windows & macOS) and the real-world map pipeline.
